...
$('#search-submit').on('click', function(event){
    ...
    startDate = $('#start-date').val(); //check the ID based on how Rosie has done datepickers update
    returnDate = $('#return-date').val(); //check the ID based on how Rosie has done datepickers update

    console.log(`Start Location: ${startLocation}`);
    console.log(`Destination: ${destination}`);
    console.log(`Start Date: ${startDate}`); 
    console.log(`End Date: ${returnDate}`);
